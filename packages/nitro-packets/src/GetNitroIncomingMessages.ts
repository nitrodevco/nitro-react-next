...
import { AcceptFriendResultMessage, AchievementMessage, AchievementNotificationMessage, AchievementsMessage, AchievementsScoreMessage, ActivityPointNotificationMessage, AvailabilityStatusMessage, AvailabilityTimeMessage, AvatarEffectActivatedMessage, AvatarEffectAddedMessage, AvatarEffectExpiredMessage, AvatarEffectSelectedMessage, AvatarEffectsMessage, BadgePointLimitsMessage, BadgeReceivedMessage, BadgesMessage, BonusRareInfoMessage, BotAddedToInventoryMessage, BotErrorEventMessage, BotInventoryMessage, BotReceivedMessage, BotRemovedFromInventoryMessage, BuildersClubFurniCountMessage, BuildersClubSubscriptionStatusMessage, BundleDiscountRulesetMessage, CallForHelpDisabledNotifyMessage, CallForHelpPendingCallsDeletedMessage, CallForHelpPendingCallsMessage, CallForHelpReplyMessage, CallForHelpResultMessage, CameraPublishStatusMessage, CameraPurchaseOKMessage, CameraSnapshotMessage, CameraStorageUrlMessage, CampaignCalendarDataMessage, CampaignCalendarDoorOpenedMessage, CancelMysteryBoxWaitMessage, CanCreateRoomEventMessage, CanCreateRoomMessage, CatalogIndexMessage, CatalogPageExpirationMessage, CatalogPageMessage, CatalogPageWithEarliestExpiryMessage, CatalogPublishedMessage, CategoriesWithVisitorCountMessage, CfhChatlogMessage, CfhSanctionMessage, CfhTopicsInitMessage, ChangeUserNameResultMessage, ChatReviewSessionDetachedMessage, ChatReviewSessionOfferedToGuideMessage, ChatReviewSessionResultsMessage, ChatReviewSessionStartedMessage, ChatReviewSessionVotingStatusMessage, ClientPingMessage, ClubGiftInfoMessage, ClubGiftNotificationMessage, ClubGiftSelectedMessage, CommunityVoteReceivedMessage, CompetitionEntrySubmitResultMessage, CompetitionRoomsDataMessage, CompetitionStatusMessage, CompetitionVotingInfoMessage, CompleteDiffieHandshakeMessage, ConfirmBreedingRequestMessage, ConfirmBreedingResultMessage, ConnectionErrorMessage, ConvertedRoomIdMessage, CraftableProductsMessage, CraftingRecipeMessage, CraftingRecipesAvailableMessage, CraftingResultMessage, CurrentTimingCodeMessage, DesktopViewMessage, DirectSMSClubBuyAvailableMessage, DisconnectReasonMessage, DoorbellMessage, ElementPointerMessage, FavoriteChangedMessage, FavoritesMessage, FigureSetIdsMessage, FigureUpdateMessage, FindFriendsProcessResultMessage, FlatAccessDeniedMessage, FlatCreatedMessage, FollowFriendFailedMessage, ForumDataMessage, FriendListFragmentMessage, FriendListUpdateMessage, FriendNotificationMessage, FriendRequestsMessage, FurnitureListAddOrUpdateMessage, FurnitureListInvalidateMessage, FurnitureListMessage, FurnitureListRemovedMessage, FurniturePostItPlacedMessage, GenericErrorMessage, GetForumsListMessage, GetGuestRoomResultMessage, GiftReceiverNotFoundMessage, GiftWrappingConfigurationMessage, GotMysteryBoxPrizeMessage, GoToBreedingNestFailureMessage, GroupBadgePartsMessage, GroupBuyDataMessage, GroupConfirmMemberRemoveMessage, GroupInformationMessage, GroupMembersMessage, GroupPurchasedMessage, GroupSettingsMessage, GuestRoomSearchResultMessage, GuideOnDutyStatusMessage, GuideReportingStatusMessage, GuideSessionAttachedMessage, GuideSessionDetachedMessage, GuideSessionEndedMessage, GuideSessionErrorMessage, GuideSessionInvitedToGuideRoomMessage, GuideSessionMessageMessage, GuideSessionPartnerIsTypingMessage, GuideSessionRequesterRoomMessage, GuideSessionStartedMessage, GuideTicketCreationResultMessage, GuideTicketResolutionMessage, GuildForumThreadsMessage, HabboBroadcastMessage, HabboClubExtendOfferMessage, HabboClubOffersMessage, HabboGroupDeactivatedMessage, HabboSearchResultMessage, HotelClosedAndOpensMessage, HotelClosesAndWillOpenAtMessage, HotelMergeNameChangeMessage, HotelWillCloseInMinutesMessage, HotelWillShutdownMessage, IdentityAccountsMessage, InfoFeedEnableMessage, InitCameraMessage, InitDiffieHandshakeMessage, InstantMessageErrorMessage, InterstitialMessage, IsBadgeRequestFulfilledMessage, IsOfferGiftableMessage, IssueCloseNotificationMessage, IssueDeletedMessage, IssueInfoMessage, IssuePickFailedMessage, IsUserPartOfCompetitionMessage, LimitedEditionSoldOutMessage, LimitedOfferAppearingNextMessage, MaintenanceStatusMessage, MarketplaceBuyOfferResultMessage, MarketplaceCancelOfferResultMessage, MarketplaceCanMakeOfferResultMessage, MarketplaceConfigurationMessage, MarketplaceItemPostedMessage, MarketplaceItemStatsMessage, MarketplaceOffersMessage, MarketplaceOwnOffersMessage, MessageErrorMessage, MessengerInitMessage, MiniMailNewMessage, MiniMailUnreadCountMessage, ModerationCautionMessage, ModeratorActionResultMessage, ModeratorInitMessage, ModeratorRoomInfoMessage, ModeratorToolsPreferencesMessage, ModeratorUserInfoMessage, MOTDNotificationMessage, MysteryBoxKeysMessage, NavigatorCollapsedMessage, NavigatorHomeRoomMessage, NavigatorLiftedMessage, NavigatorMetadataMessage, NavigatorOpenRoomCreatorMessage, NavigatorSavedSearchesMessage, NavigatorSearchMessage, NavigatorSettingsMessage, NestBreedingSuccessMessage, NewConsoleMessage, NewFriendRequestMessage, NoobnessLevelMessage, NoOwnedRoomsAlertMessage, NotEnoughBalanceMessage, NotificationDialogMessage, OfferRewardDeliveredMessage, PetAddedToInventoryMessage, PetBreedingMessage, PetInventoryMessage, PetLevelNotificationMessage, PetPlacingErrorEventMessage, PetReceivedMessage, PetRemovedFromInventoryMessage, PhoneCollectionStateMessage, PostMessageMessage, PostThreadMessage, PresentOpenedMessage, ProductOfferMessage, PromoArticlesMessage, PurchaseErrorMessage, PurchaseNotAllowedMessage, PurchaseOKMessage, QuizDataMessage, QuizResultsMessage, RestoreClientMessage, RoomAdErrorMessage, RoomAdPurchaseInfoMessage, RoomChatlogMessage, RoomEventCancelMessage, RoomEventMessage, RoomInviteErrorMessage, RoomInviteMessage, RoomSettingsUpdatedMessage, RoomThumbnailUpdateResultMessage, RoomVisitsMessage, SanctionStatusMessage, SeasonalCalendarDailyOfferMessage, SecondsUntilMessage, SellablePetPalettesMessage, ShowMysteryBoxWaitMessage, TargetedOfferMessage, TargetedOfferNotFoundMessage, ThreadMessagesMessage, ThumbnailStatusMessage, TradingAcceptMessage, TradingCloseMessage, TradingCompletedMessage, TradingConfirmationMessage, TradingListItemMessage, TradingNoSuchItemMessage, TradingNotOpenMessage, TradingOpenFailedMessage, TradingOpenMessage, TradingOtherNotAllowedMessage, TradingYouAreNotAllowedMessage, TryPhoneNumberResultMessage, TryVerificationCodeResultMessage, UnreadForumsCountMessage, UnseenItemsMessage, UpdateMessageMessage, UpdateThreadMessage, UserBannedMessage, UserChatlogMessage, UserCreditsMessage, UserEventCatsMessage, UserFlatCatsMessage, VoucherRedeemErrorMessage, VoucherRedeemOkMessage, WardrobeMessage } from './incoming';
...
export const GetNitroIncomingMessages = () =>
{
    return {
        ...
        [IncomingHeader.CAN_CREATE_ROOM_EVENT]: CanCreateRoomEventMessage,
        [IncomingHeader.CAN_CREATE_ROOM]: CanCreateRoomMessage,
        [IncomingHeader.CATEGORIES_WITH_VISITOR_COUNT]: CategoriesWithVisitorCountMessage,
        [IncomingHeader.COMPETITION_ROOMS_DATA]: CompetitionRoomsDataMessage,
        [IncomingHeader.CONVERTED_ROOM_ID]: ConvertedRoomIdMessage,
        [IncomingHeader.ROOM_DOORBELL]: DoorbellMessage,
        [IncomingHeader.USER_FAVORITE_ROOM]: FavoriteChangedMessage,
        [IncomingHeader.USER_FAVORITE_ROOM_COUNT]: FavoritesMessage,
        [IncomingHeader.ROOM_DOORBELL_REJECTED]: FlatAccessDeniedMessage,
        [IncomingHeader.ROOM_CREATED]: FlatCreatedMessage,
        [IncomingHeader.ROOM_INFO]: GetGuestRoomResultMessage,
        [IncomingHeader.GUEST_ROOM_SEARCH_RESULT]: GuestRoomSearchResultMessage,
        [IncomingHeader.USER_HOME_ROOM]: NavigatorHomeRoomMessage,
        [IncomingHeader.NAVIGATOR_OPEN_ROOM_CREATOR]: NavigatorOpenRoomCreatorMessage,
        [IncomingHeader.ROOM_EVENT_CANCEL]: RoomEventCancelMessage,
        [IncomingHeader.ROOM_EVENT]: RoomEventMessage,
        [IncomingHeader.ROOM_INFO_UPDATED]: RoomSettingsUpdatedMessage,
        [IncomingHeader.THUMBNAIL_UPDATE_RESULT]: RoomThumbnailUpdateResultMessage,
        [IncomingHeader.NAVIGATOR_EVENT_CATEGORIES]: UserEventCatsMessage,
        [IncomingHeader.NAVIGATOR_CATEGORIES]: UserFlatCatsMessage,
        [IncomingHeader.NAVIGATOR_COLLAPSED]: NavigatorCollapsedMessage,
        [IncomingHeader.NAVIGATOR_LIFTED]: NavigatorLiftedMessage,
        [IncomingHeader.NAVIGATOR_METADATA]: NavigatorMetadataMessage,
        [IncomingHeader.NAVIGATOR_SEARCHES]: NavigatorSavedSearchesMessage,
        [IncomingHeader.NAVIGATOR_SEARCH]: NavigatorSearchMessage,
        [IncomingHeader.NAVIGATOR_SETTINGS]: NavigatorSettingsMessage,
        [IncomingHeader.ACHIEVEMENT_NOTIFICATION]: AchievementNotificationMessage,
        [IncomingHeader.ACTIVITY_POINT_NOTIFICATION]: ActivityPointNotificationMessage,
        [IncomingHeader.BOT_ERROR]: BotErrorEventMessage,
        [IncomingHeader.CLUB_GIFT_NOTIFICATION]: ClubGiftNotificationMessage,
        [IncomingHeader.CONNECTION_ERROR]: ConnectionErrorMessage,
        [IncomingHeader.NOTIFICATION_ELEMENT_POINTER]: ElementPointerMessage,
        [IncomingHeader.GENERIC_ALERT]: HabboBroadcastMessage,
        [IncomingHeader.HOTEL_WILL_CLOSE_MINUTES]: HotelWillShutdownMessage,
        [IncomingHeader.INFO_FEED_ENABLE]: InfoFeedEnableMessage,
        [IncomingHeader.MOTD_MESSAGES]: MOTDNotificationMessage,
        [IncomingHeader.NOTIFICATION_LIST]: NotificationDialogMessage,
        [IncomingHeader.NOTIFICATION_OFFER_REWARD_DELIVERED]: OfferRewardDeliveredMessage,
        [IncomingHeader.PET_LEVEL_NOTIFICATION]: PetLevelNotificationMessage,
        [IncomingHeader.PET_PLACING_ERROR]: PetPlacingErrorEventMessage,
        [IncomingHeader.RESTORE_CLIENT]: RestoreClientMessage,
        [IncomingHeader.UNSEEN_ITEMS]: UnseenItemsMessage
