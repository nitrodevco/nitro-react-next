...
export class RoomUsersHandler extends BaseHandler
{
    ...
    private onRoomUnitEvent(event: RoomUnitEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionUserDataUpdateEvent(session, usersToAdd));
    }
    ...
    private onRoomUnitInfoEvent(event: RoomUnitInfoEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionUserFigureUpdateEvent(session, parser.unitId, parser.figure, parser.gender, parser.motto, parser.achievementScore));
    ...
    private onRoomUnitDanceEvent(event: RoomUnitDanceEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionDanceEvent(session, parser.unitId, parser.danceId));
    }
    ...
    private onUserCurrentBadgesEvent(event: UserCurrentBadgesEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionUserBadgesEvent(session, parser.userId, parser.badges));
    }
    ...
    private onRoomDoorbellEvent(event: DoorbellMessageEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.DOORBELL, session, username));
    }
    ...
    private onNewFriendRequestEvent(event: NewFriendRequestEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionFriendRequestEvent(session, request.requestId, request.requesterUserId, request.requesterName));
    }
    ...
    private onPetInfoEvent(event: PetInfoEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionPetInfoUpdateEvent(session, petData));
    }
    ...
    private onPetStatusUpdateEvent(event: PetStatusUpdateEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionPetStatusUpdateEvent(session, parser.petId, parser.canBreed, parser.canHarvest, parser.canRevive, parser.hasBreedingPermission));
    }
    ...
    private onPetBreedingMessageEvent(event: PetBreedingMessageEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionPetBreedingEvent(session, parser.state, parser.ownPetId, parser.otherPetId));
    }
    ...
    private onPetLevelUpdateMessageEvent(event: PetLevelUpdateMessageEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionPetLevelUpdateEvent(session, parser.petId, parser.level));
    }
    ...
    private onConfirmBreedingResultEvent(event: ConfirmBreedingResultEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionConfirmPetBreedingResultEvent(session, parser.breedingNestStuffId, parser.result));
    }
    ...
    private onNestBreedingSuccessEvent(event: NestBreedingSuccessEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionNestBreedingSuccessEvent(session, parser.petId, parser.rarityCategory));
    }
    ...
    private onConfirmBreedingRequestEvent(event: ConfirmBreedingRequestEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionConfirmPetBreedingEvent(session, parser.nestId, parser.pet1, parser.pet2, parser.rarityCategories, parser.resultPetType));
    }
    ...
    private onPetFigureUpdateEvent(event: PetFigureUpdateEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionPetFigureUpdateEvent(session, parser.petId, figure));
    }
    ...
    private onPetBreedingResultEvent(event: PetBreedingResultEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionPetBreedingResultEvent(session, parser.resultData, parser.otherResultData));
    }
    ...
    private onPetPlacingError(event: PetPlacingErrorEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionErrorMessageEvent(type, session));
    }
    ...
    private onFavoriteMembershipUpdateMessageEvent(event: FavoriteMembershipUpdateMessageEvent): void
    {
        ...
        EventStore.getState().emit(new RoomSessionFavoriteGroupUpdateEvent(session, parser.roomIndex, parser.groupId, parser.status, parser.groupName));
    }
}
