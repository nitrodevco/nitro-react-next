import { IRoomUserData, IUserDataManager } from '#renderer/api';
import { GetCommunication, RequestPetInfoComposer, UserCurrentBadgesComposer } from '#renderer/communication';
