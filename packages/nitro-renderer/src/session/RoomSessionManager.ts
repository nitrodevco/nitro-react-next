...
export class RoomSessionManager implements IRoomSessionManager, IRoomHandlerListener
{
    ...
    private addSession(roomSession: IRoomSession): boolean
    {
        ...
        EventStore.getState().emit(new RoomSessionEvent(RoomSessionEvent.CREATED, roomSession));
    ...
    public startSession(session: IRoomSession): boolean
    {
        ...
        EventStore.getState().emit(new RoomSessionEvent(RoomSessionEvent.STARTED, session));
    ...
    public removeSession(id: number, openLandingView: boolean = true): void
    {
        ...
        EventStore.getState().emit(new RoomSessionEvent(RoomSessionEvent.ENDED, session, openLandingView));
    }
