import { IEventDispatcher, IRoomObjectEventHandler, IRoomObjectLogicFactory, RoomObjectLogicType } from '#renderer/api';
import { EventDispatcher, RoomObjectEvent } from '#renderer/events';
