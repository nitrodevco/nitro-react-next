import { IRoomGeometry, MouseEventType, RoomObjectVariable, StringDataType } from '#renderer/api';
import { RoomObjectBadgeAssetEvent, RoomObjectWidgetRequestEvent, RoomSpriteMouseEvent } from '#renderer/events';
