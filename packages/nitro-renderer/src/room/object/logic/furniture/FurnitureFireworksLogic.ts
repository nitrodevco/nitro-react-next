import { IAssetData, IParticleSystem, IRoomGeometry, MouseEventType, RoomObjectVariable } from '#renderer/api';
import { RoomObjectEvent, RoomObjectStateChangedEvent, RoomSpriteMouseEvent } from '#renderer/events';
