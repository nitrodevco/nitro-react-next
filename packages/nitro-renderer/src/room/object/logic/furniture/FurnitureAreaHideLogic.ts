import { IRoomGeometry, MouseEventType, NumberDataType, RoomObjectVariable } from '#renderer/api';
import { RoomObjectEvent, RoomObjectStateChangedEvent, RoomObjectWidgetRequestEvent, RoomSpriteMouseEvent } from '#renderer/events';
