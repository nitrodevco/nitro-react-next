import { IAssetData, IRoomGeometry, MouseEventType, RoomObjectVariable } from '#renderer/api';
import { RoomObjectWidgetRequestEvent, RoomSpriteMouseEvent } from '#renderer/events';
