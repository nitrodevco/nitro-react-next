import { IAssetData, IRoomGeometry, MapDataType, MouseEventType, RoomObjectVariable, RoomWidgetEnumItemExtradataParameter } from '#renderer/api';
import { GetAssetManager } from '#renderer/assets';
import { RoomObjectRoomAdEvent, RoomSpriteMouseEvent } from '#renderer/events';
