...
export class AvatarRenderManager implements IAvatarRenderManager
{
    ...
    public async init(): Promise<void>
    {
        ...
        EventStore.getState().subscribe(NitroEventType.AVATAR_ASSET_LOADED, () => this._aliasCollection.reset());
        EventStore.getState().subscribe(NitroEventType.AVATAR_EFFECT_LOADED, () => this._aliasCollection.reset());
