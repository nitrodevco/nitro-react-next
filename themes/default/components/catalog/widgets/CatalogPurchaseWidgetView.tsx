...
}> = props =>
{
    ...
    useEventListener({
        [CatalogPurchasedEvent.PURCHASE_SUCCESS]: event => setPurchaseState(CatalogPurchaseState.NONE),
        [CatalogPurchaseFailureEvent.PURCHASE_FAILED]: event => setPurchaseState(CatalogPurchaseState.FAILED),
        [CatalogPurchaseNotAllowedEvent.NOT_ALLOWED]: event => setPurchaseState(CatalogPurchaseState.FAILED),
        [CatalogPurchaseSoldOutEvent.SOLD_OUT]: event => setPurchaseState(CatalogPurchaseState.SOLD_OUT)
    });
