import { CanManipulateFurniture, DispatchUiEvent, GetRoomSession, IsFurnitureSelectionDisabled, ProcessRoomObjectOperation, RoomWidgetUpdateRoomObjectEvent, SetActiveRoomId, StartRoomSession } from '#base/api';
import { useRoomStore } from '#base/stores';
import { RoomEngineEvent, RoomEngineObjectEvent, RoomId, RoomObjectCategory, RoomObjectOperationType, RoomSessionEvent } from '@nitrots/nitro-renderer';
